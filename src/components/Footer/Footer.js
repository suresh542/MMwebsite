...
class Footer extends Component {
    ...
    addEditHandler = (param) => {
        ...
        this.setState({ isModalOpen: false, modalData: undefined, isStateUpdated: false,isCommingSoonModalOpen: false })
    }

    render() {
        const { isModalOpen, modalData, isDeleteModalOpen, pagination,isCommingSoonModalOpen } = this.state;
        return (
            <div>
                        ...
                        <div class="row" id='HomeList'>
                            <div class="col">
                                <div className='HomeListDeta'>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><span className="Home" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.home, "point": "homeScroll", "height": '100' })}>Home</span></td>
                                            <td><span className="FooterDiv-How-it-Works" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.order, "point": "orderScroll", "height": '100' })}>   How it Works</span></td>
                                            ...
                                            <td><span className="Corporate-and-Teams" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.corporateandteams, "point": "CorporateandTeams", "height": '100' })}>Corporate and Teams</span></td>
                                            <td><span className="Ambassador-Program" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.brandambassador, "point": "brandambassadorScroll", "height": '100' })}>Ambassador Program</span></td>

                                        </tr>

                                        <tr>
                                            <td><span className="FooterDiv-Shop" onClick={() => this.setState({ isCommingSoonModalOpen: true, modalData: undefined })}>  Shop</span></td>
                                            <td><span className="FooterDiv-Easy-Gifting" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.gift, "point": "giftScroll", "height": '100' })}>  Easy Gifting</span></td>
                                            ...
                                            <td><span class="Landlords-and-Buildings" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.corporateandteams, "point": "landlordsAndBuildings", "height": '2000' })}>  Landlords and Buildings</span></td>
                                            <td><span class="App" onClick={() => this.setState({ isCommingSoonModalOpen: true, modalData: undefined })}>App</span></td>
                                        </tr>
                                        <tr>
                                            <td><span class="The-Movement" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.movement, "point": "movementScroll", "height": '100' })}>The Movement</span></td>
                                            <td><span class="FooterDiv-Meaningful-Donation" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.ngo, "point": "donationScroll", "height": '100' })}>  Meaningful Donation</span></td>
                                            ...
                                            <td><span class="Universities" style={{ cursor: 'pointer' }} onClick={() => this.routeNavigate({ "navigate": URL_MAP.corporateandteams, "point": "Universities", "height": '3500' })}>Universities</span></td>
                                            <td><span class="Site-Map" onClick={() => this.setState({ isCommingSoonModalOpen: true, modalData: undefined })}>Site Map</span></td>
